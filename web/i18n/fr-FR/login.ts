const translation = {
  ...
  welcome: 'Bienvenue sur Racio, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Racio Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Racio',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Racio',
