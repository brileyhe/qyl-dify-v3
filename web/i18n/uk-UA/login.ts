const translation = {
  ...
  welcome: 'Ласкаво просимо до Racio, будь ласка, увійдіть, щоб продовжити.',
  ...
  withWeChat: 'Продовжити з GitHub',
  ...
  license: {
    tip: 'Перед запуском Racio Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Racio',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Racio',
