...
import Nav from '../racio-nav'
import { type NavItem } from '../nav/nav-selector'
import { Robot, RobotActive } from '@/app/components/base/icons/src/public/header-nav/studio'
  ...
  return (
    <>
      <Nav
        ...
        text={t('racio.training.title')}
        activeSegment={['training', 'app']}
        link='/training'
        curNav={appDetail}
        navs={navItems}
